// Identifier คือ ชื่อที่ dev ตั้งขึ้นมาเอง (ตัวแปร, ฟังก์ชั่น, ค่าคงที่, คลาส, ออปเจ็กต์) ต้องเป็นไปตามกฏการตั้งชื่อ
// - ไม่เว้นวรรค์ ไม่ขึ้นต้นด้วยตัวเลข ไม่ใช้คำสงวน/ค่าสัญ (reserved word/keyword)
...
var dti01 = "aaa"  // แก้ไขได้ เป็น goble  ใช้ที่ไหนก้ได้
let dti02 = "bbb"  // แก้ไขได้ เป็น Local  ใช้เฉพาะที่****
